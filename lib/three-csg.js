function csg(three) {
    ...
    csgThree.BSPNode = BSPNode;
    csgThree.boolean = boolean;
    csgThree.booleanOperation = booleanOperation;
    csgThree.booleanOperationArray = booleanOperationArray;
    csgThree.cache = cache;
    csgThree.convertGeometryToTriangles = convertGeometryToTriangles;
    csgThree.intersect = intersect$1;
    csgThree.subtract = subtract$1;
    csgThree.transformBSP = transformBSP;
    csgThree.union = union$1;
